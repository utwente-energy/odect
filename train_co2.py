...
# add co2 emissions to the output dataframe
...
data_out[measurement+"_"+field+"_AEF"] = copy.deepcopy(r)
...
data_in[measurement+"_"+field+"_AEF"] = copy.deepcopy(r)
...
# Save scalars
joblib.dump(scaler_in , "training/scalar_in_co2_forecast") 
joblib.dump(scaler_out, "training/scalar_out_co2_forecast") 
